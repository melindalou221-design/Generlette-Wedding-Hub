export const wedding = {
  couple: 'Cory & Melinda',
  date: '2026-09-28',
  hashtag: '#FinallyGenerlette',
  ceremony: {
    name: 'Sunrise Amphitheater',
    city: 'Boulder, Colorado',
    time: '3:30 PM',
    coordinates: [40.00368, -105.30082],
    mapsQuery: 'Sunrise Amphitheater Boulder Colorado',
  },
  reception: {
    name: 'City Park Pavilion',
    address: '2001 Steele Street, Denver, CO 80206',
    time: '5:00 PM',
    coordinates: [39.7462645, -104.9523469],
    mapsQuery: 'City Park Pavilion 2001 Steele Street Denver Colorado',
  },
  links: {
    ...
    adventureHub: 'https://denvergov.org/Government/Agencies-Departments-Offices/Agencies-Departments-Offices-Directory/Parks-Recreation/Recreation-Centers-Pools-Activities/Adventure-Hub-Bike-and-Boat-Rentals',
    adventureHubImage: 'https://assets.simpleviewinc.com/simpleview/image/upload/c_fill%2Cf_jpg%2Ch_434%2Cq_65%2Cw_640/v1/clients/denver/boating_city_park_spring_summer_things_to_do_89e8f8f9-de32-45f7-83ff-0e82f5287fb0.jpg',
    swanBoatPhotoSource: 'https://visitdenver.com/',
  },
};
...
export const schedule = [
  ...
  ['8:15 PM', 'Anniversary Dance', 'All couples are invited to the dance floor — the longest-married couple stays for the final spotlight.'],
...
export const gallery = [
  ['IMG_5958.webp', 'Mountain memories'],
  ['IMG_7951.webp', 'Date night energy'],
  ['IMG_3247.webp', 'One of many date-night selfies'],
  ['IMG_8501.webp', 'Just us'],
  ['A3B71489.webp', 'Colorado days'],
  ['date-night-43D.webp', 'Dressed up and still laughing'],
  ['IMG_5274.webp', 'Adventure together'],
  ['adventure-2B47.webp', 'Colorado keeps giving us reasons to explore'],
  ['IMG_6615.webp', 'Cheers to us'],
  ['IMG_7194.webp', 'Another night, another memory'],
  ['CRI_9149.webp', 'Our family'],
  ['IMG_4258.webp', 'Golden Colorado days'],
  ['IMG_3342.webp', 'Adventure together'],
  ['IMG_1089.webp', 'Mountain memories'],
  ['IMG_6754.webp', 'Cozy crew'],
  ['IMG_7935.webp', 'Road-trip energy'],
  ['IMG_0842.webp', 'Colorado sunset'],
];
...
export const weekend = {
  ...
  happening: {
    intro: 'Wedding week lands in the middle of a busy stretch in Denver. Here is what is going on between Friday the 25th and Tuesday the 29th, so you can build a trip around it — and so you know which nights the traffic is going to be ugly.',
    days: [
      {
        label: 'FRIDAY · SEPTEMBER 25',
        heading: 'Oktoberfest opens, hockey downtown, Red Rocks packed',
        events: [
          {time:'3:00 PM', name:'Denver Oktoberfest (weekend two)', where:'Larimer St between 20th and 22nd, Ballpark neighborhood', detail:'Denver’s 56th year and the longest continuously running Oktoberfest in the country. General admission is free — walk in for the live music, German food, stein hoisting and the dachshund races. Open until midnight. Street parking is almost impossible; take the train to Union Station or 20th/Welton.'},
          {time:'6:30 PM', name:'Avalanche vs. Winnipeg Jets', where:'Ball Arena', detail:'NHL preseason, and the Avs’ last home tune-up before the season opener. Cheaper and easier to get into than a regular-season game.'},
          {time:'8:00 PM', name:'The Revivalists, with Ax and the Hatchetmen', where:'Red Rocks Amphitheatre, Morrison', detail:'If you only do one Red Rocks show this trip, a Friday night is the one to pick. Bring a real jacket — it gets cold up there after dark.'},
          {time:'8:00 PM', name:'Prospa', where:'Mission Ballroom, RiNo', detail:'UK dance duo. Ages 16+.'},
        ],
      },
      {
        label: 'SATURDAY · SEPTEMBER 26',
        heading: 'The biggest day to be a tourist here',
        events: [
          {time:'8:00 AM', name:'SnowShape fitness series', where:'Red Rocks Amphitheatre, Morrison', detail:'The famous stadium-stair workout, organized. Or just show up on your own and climb the stairs for free — the park is open to walk in any time there is no show being set up.'},
          {time:'11:00 AM', name:'Denver Oktoberfest, day two', where:'Larimer St between 20th and 22nd', detail:'The full day — open 11:00 AM to midnight, still free to get in. Stein-hoisting qualifiers run until 5:00 PM.'},
          {time:'6:00 PM', name:'Big Gigantic, with The Funk Hunters, Motifv and Drew Birch', where:'Red Rocks Amphitheatre, Morrison', detail:'Boulder-born electronic duo playing their hometown-ish room. Expect a full house.'},
          {time:'8:00 PM', name:'Yacht Rock Revue', where:'Mission Ballroom, RiNo', detail:'Smooth soft-rock covers, and a genuinely fun night out. Ages 16+.'},
        ],
      },
      {
        label: 'SUNDAY · SEPTEMBER 27 · REHEARSAL DAY',
        heading: 'Sunday Night Football is in town — plan around it',
        warn: 'Heads up for anyone in the rehearsal: the Broncos play at home that evening and downtown Denver plus I-25 will be slow from late afternoon on. Our rehearsal is up on Flagstaff Mountain in Boulder, so it does not collide directly — but leave extra time if you are driving through or around Denver to get to Boulder.',
        events: [
          {time:'6:20 PM', name:'Broncos vs. Los Angeles Rams', where:'Empower Field at Mile High', detail:'Sunday Night Football on NBC. Expect heavy traffic and full parking anywhere near downtown and the stadium from about 4:00 PM.'},
          {time:'11:00 AM', name:'Denver Oktoberfest, final day', where:'Larimer St between 20th and 22nd', detail:'Last chance — this one closes early, at 6:00 PM.'},
          {time:'7:30 PM', name:'JUNGLE, with RIO KOSTA', where:'Red Rocks Amphitheatre, Morrison', detail:'Two-night Red Rocks run starts tonight.'},
          {time:'8:00 PM', name:'World of Warcraft: 20 Years of Music', where:'Mission Ballroom, RiNo', detail:'The game score performed live. Unexpectedly great, and a soft sell even if you have never played it.'},
        ],
      },
      {
        label: 'MONDAY · SEPTEMBER 28 · WEDDING DAY',
        heading: 'Our day — but the city is busy too',
        warn: 'Breaking Benjamin is at Ball Arena the same evening as our reception. Ball Arena is only a few miles from City Park Pavilion and its lots open three hours early, so downtown traffic will be building right as you are heading to us. Give yourself an extra fifteen minutes coming down from the mountain.',
        events: [
          {time:'6:00 PM', name:'Breaking Benjamin, with Chevelle, Starset and Kami Kehoe', where:'Ball Arena', detail:'Same night as the reception — noted here for traffic, not as a suggestion.'},
          {time:'7:30 PM', name:'JUNGLE, with RIO KOSTA', where:'Red Rocks Amphitheatre, Morrison', detail:'Night two of the Red Rocks run. Also the same night as the reception.'},
        ],
      },
      {
        label: 'TUESDAY · SEPTEMBER 29',
        heading: 'Staying an extra day?',
        events: [
          {time:'7:00 PM', name:'Coheed and Cambria: Neverender Rocks, with Turnover and The Home Team', where:'Red Rocks Amphitheatre, Morrison', detail:'A good excuse to fly out Wednesday instead of Tuesday.'},
        ],
      },
    ],
    notes: [
      'The Rockies are on the road that whole stretch — at the White Sox September 25 through 27 — and the regular season ends September 27, so there is no baseball at Coors Field during the wedding weekend. Their last home game is Thursday, September 24 against Arizona at 3:10 PM if you are flying in early.',
      'No college football in Boulder either: CU is away at Baylor on Saturday the 26th, and the Rapids are away at the LA Galaxy the same day.',
      'Red Rocks shows are rain or shine and the amphitheater is a serious set of stairs at 6,400 feet. Park in the upper lots if you want the shortest walk down, and take it slow your first day in Colorado.',
      'Everything above was accurate when we built this page. Dates and start times move, so tap through to the venue before you buy anything.',
    ],
    links: [
      {label:'Red Rocks event calendar', url:'https://www.redrocksonline.com/events/'},
      {label:'Ball Arena events', url:'https://www.ballarena.com/'},
      {label:'Mission Ballroom shows', url:'https://do303.com/venues/mission-ballroom'},
      {label:'Denver Oktoberfest', url:'https://thedenveroktoberfest.com/'},
      {label:'Broncos tickets + schedule', url:'https://www.denverbroncos.com/schedule/'},
    ],
  },
  honeymoon: {
...
export const coloradoQuestions = [
  {q:'Which famous Colorado landmark is just outside Colorado Springs?', choices:['Garden of the Gods','The Space Needle','Niagara Falls'], a:0, fact:'Garden of the Gods is known for dramatic red sandstone formations.'},
  {q:'Colorado is nicknamed the…', choices:['Centennial State','Sunshine State','Volunteer State'], a:0, fact:'Colorado became a state in 1876, 100 years after the Declaration of Independence.'},
  {q:'What is Colorado’s state flower?', choices:['Rocky Mountain columbine','Magnolia','Sunflower'], a:0, fact:'The white-and-lavender Rocky Mountain columbine is Colorado’s state flower.'},
  {q:'Which animal is Colorado’s state animal?', choices:['Rocky Mountain bighorn sheep','Moose','Black bear'], a:0, fact:'The Rocky Mountain bighorn sheep is Colorado’s state animal.'},
  {q:'Pikes Peak is closest to which city?', choices:['Colorado Springs','Fort Collins','Grand Junction'], a:0, fact:'Pikes Peak rises above the Colorado Springs area.'},
  {q:'Red Rocks Amphitheatre is famous for…', choices:['Concerts among giant red rock formations','Indoor ice skating','Ocean views'], a:0, fact:'Red Rocks is a world-famous open-air music venue built into natural rock formations.'},
];
...
export const guestFaq = [
  ...
  ['What are the ceremony restroom facilities like?', 'Sunrise Amphitheater has pit-latrine restrooms and no changing rooms.'],
  ...
  ['What are the swan boats?', 'Ferril Lake is right beside City Park Pavilion. On Monday, September 28, Adventure Hub is scheduled for 3:30–8:00 PM fall hours, with the last rental at 7:00 PM. A 4-person Swan Pedal Boat is $35 per hour, no reservation is required, life jackets are included, and rentals are first come, first served. Weather or lightning can close the lake.'],
  ['Is there anything special during cocktail hour?', 'Yes — take a short stroll to Sopris Garden, just west of City Park Pavilion, and keep an eye out for a little magic surprise ✨.'],
